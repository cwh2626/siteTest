  ...
  " >
  	...
  	<tr>
  		<td>
            ...
            <input type="text" name="email" class="form-control form-control-lg form-control-a" placeholder="이메일을 입력하세">
  		</td>
  	</tr>
  	<tr>
  		<td>
  	...
  	<tr>
  		<td>
            ...
            <input type="text" name="nickname" class="form-control form-control-lg form-control-a" placeholder="사용할 닉네임을 입력하세">
  		</td>
  	</tr>
